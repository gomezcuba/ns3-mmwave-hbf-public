...
#include <ns3/log.h>
#include <ns3/abort.h>
#include "mmwave-async-avoid-hbf-mac-scheduler.h"
...
NS_LOG_COMPONENT_DEFINE ("MmWaveInterAvoidHbfMacScheduler");

NS_OBJECT_ENSURE_REGISTERED (MmWaveInterAvoidHbfMacScheduler);

class MmWaveInterAvoidHbfMacCschedSapProvider : public MmWaveMacCschedSapProvider
{
public:
  MmWaveInterAvoidHbfMacCschedSapProvider (MmWaveInterAvoidHbfMacScheduler* scheduler);
...
private:
  MmWaveInterAvoidHbfMacCschedSapProvider ();
  MmWaveInterAvoidHbfMacScheduler* m_scheduler;
};

MmWaveInterAvoidHbfMacCschedSapProvider::MmWaveInterAvoidHbfMacCschedSapProvider ()
{
}

MmWaveInterAvoidHbfMacCschedSapProvider::MmWaveInterAvoidHbfMacCschedSapProvider (MmWaveInterAvoidHbfMacScheduler* scheduler)
  : m_scheduler (scheduler)
{
}

void
MmWaveInterAvoidHbfMacCschedSapProvider::CschedCellConfigReq (const struct MmWaveMacCschedSapProvider::CschedCellConfigReqParameters& params)
{
  m_scheduler->DoCschedCellConfigReq (params);
}

void
MmWaveInterAvoidHbfMacCschedSapProvider::CschedUeConfigReq (const struct MmWaveMacCschedSapProvider::CschedUeConfigReqParameters& params)
{
...
void
MmWaveInterAvoidHbfMacCschedSapProvider::CschedLcConfigReq (const struct MmWaveMacCschedSapProvider::CschedLcConfigReqParameters& params)
{
  m_scheduler->DoCschedLcConfigReq (params);
}

void
MmWaveInterAvoidHbfMacCschedSapProvider::CschedLcReleaseReq (const struct MmWaveMacCschedSapProvider::CschedLcReleaseReqParameters& params)
{
  m_scheduler->DoCschedLcReleaseReq (params);
}

void
MmWaveInterAvoidHbfMacCschedSapProvider::CschedUeReleaseReq (const struct MmWaveMacCschedSapProvider::CschedUeReleaseReqParameters& params)
{
  m_scheduler->DoCschedUeReleaseReq (params);
}

class MmWaveInterAvoidHbfMacSchedSapProvider : public MmWaveMacSchedSapProvider
{
public:
  MmWaveInterAvoidHbfMacSchedSapProvider (MmWaveInterAvoidHbfMacScheduler* sched);
...
private:
  MmWaveInterAvoidHbfMacSchedSapProvider ();
  MmWaveInterAvoidHbfMacScheduler* m_scheduler;
};

MmWaveInterAvoidHbfMacSchedSapProvider::MmWaveInterAvoidHbfMacSchedSapProvider ()
{
}

MmWaveInterAvoidHbfMacSchedSapProvider::MmWaveInterAvoidHbfMacSchedSapProvider (MmWaveInterAvoidHbfMacScheduler* sched)
  : m_scheduler (sched)
{
}

void
MmWaveInterAvoidHbfMacSchedSapProvider::SchedDlRlcBufferReq (const struct MmWaveMacSchedSapProvider::SchedDlRlcBufferReqParameters& params)
{
  m_scheduler->DoSchedDlRlcBufferReq (params);
}

void
MmWaveInterAvoidHbfMacSchedSapProvider::SchedTriggerReq (const struct MmWaveMacSchedSapProvider::SchedTriggerReqParameters& params)
{
  m_scheduler->DoSchedTriggerReq (params);
}

void
MmWaveInterAvoidHbfMacSchedSapProvider::SchedDlCqiInfoReq (const struct MmWaveMacSchedSapProvider::SchedDlCqiInfoReqParameters& params)
{
  m_scheduler->DoSchedDlCqiInfoReq (params);
}

void
MmWaveInterAvoidHbfMacSchedSapProvider::SchedUlCqiInfoReq (const struct MmWaveMacSchedSapProvider::SchedUlCqiInfoReqParameters& params)
{
  m_scheduler->DoSchedUlCqiInfoReq (params);
}

void
MmWaveInterAvoidHbfMacSchedSapProvider::SchedUlMacCtrlInfoReq (const struct MmWaveMacSchedSapProvider::SchedUlMacCtrlInfoReqParameters& params)
{
  m_scheduler->DoSchedUlMacCtrlInfoReq (params);
}

void
MmWaveInterAvoidHbfMacSchedSapProvider::SchedSetMcs (int mcs)
{
  m_scheduler->DoSchedSetMcs (mcs);
}

const unsigned MmWaveInterAvoidHbfMacScheduler::m_macHdrSize = 0;
const unsigned MmWaveInterAvoidHbfMacScheduler::m_subHdrSize = 4;
const unsigned MmWaveInterAvoidHbfMacScheduler::m_rlcHdrSize = 3;

const double MmWaveInterAvoidHbfMacScheduler::m_berDl = 0.001;

MmWaveInterAvoidHbfMacScheduler::MmWaveInterAvoidHbfMacScheduler ()
  : m_nextRnti (0),
    m_subframeNo (0),
    m_tbUid (0),
    m_macSchedSapUser (0),
    m_macCschedSapUser (0)
{
  ...
  m_macSchedSapProvider = new MmWaveInterAvoidHbfMacSchedSapProvider (this);
  m_macCschedSapProvider = new MmWaveInterAvoidHbfMacCschedSapProvider (this);
}
...
void
MmWaveInterAvoidHbfMacScheduler::DoDispose (void)
{
  NS_LOG_FUNCTION (this);
  m_wbCqiRxed.clear ();
...
TypeId
MmWaveInterAvoidHbfMacScheduler::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::MmWaveInterAvoidHbfMacScheduler")
    .SetParent<MmWaveMacScheduler> ()
    .AddConstructor<MmWaveInterAvoidHbfMacScheduler> ()
    .AddAttribute ("CqiTimerThreshold",
                   "The number of TTIs a CQI is valid (default 1000 - 1 sec.)",
                   UintegerValue (100),
                   MakeUintegerAccessor (&MmWaveInterAvoidHbfMacScheduler::m_cqiTimersThreshold),
                   MakeUintegerChecker<uint32_t> ())
    .AddAttribute ("HarqEnabled",
                   "Activate/Deactivate the HARQ [by default is active].",
                   BooleanValue (false),
                   MakeBooleanAccessor (&MmWaveInterAvoidHbfMacScheduler::m_harqOn),
                   MakeBooleanChecker ())
    .AddAttribute ("FixedMcsDl",
                   "Fix MCS to value set in McsDlDefault (for testing)",
                   BooleanValue (false),
                   MakeBooleanAccessor (&MmWaveInterAvoidHbfMacScheduler::m_fixedMcsDl),
                   MakeBooleanChecker ())
    .AddAttribute ("McsDefaultDl",
                   "Fixed DL MCS (for testing)",
                   UintegerValue (1),
                   MakeUintegerAccessor (&MmWaveInterAvoidHbfMacScheduler::m_mcsDefaultDl),
                   MakeUintegerChecker<uint8_t> ())
    .AddAttribute ("FixedMcsUl",
                   "Fix MCS to value set in McsUlDefault (for testing)",
                   BooleanValue (false),
                   MakeBooleanAccessor (&MmWaveInterAvoidHbfMacScheduler::m_fixedMcsUl),
                   MakeBooleanChecker ())
    .AddAttribute ("McsDefaultUl",
                   "Fixed UL MCS (for testing)",
                   UintegerValue (1),
                   MakeUintegerAccessor (&MmWaveInterAvoidHbfMacScheduler::m_mcsDefaultUl),
                   MakeUintegerChecker<uint8_t> ())
    .AddAttribute ("DlSchedOnly",
                   "Only schedule downlink traffic (for testing)",
                   BooleanValue (false),
                   MakeBooleanAccessor (&MmWaveInterAvoidHbfMacScheduler::m_dlOnly),
                   MakeBooleanChecker ())
    .AddAttribute ("UlSchedOnly",
                   "Only schedule uplink traffic (for testing)",
                   BooleanValue (false),
                   MakeBooleanAccessor (&MmWaveInterAvoidHbfMacScheduler::m_ulOnly),
                   MakeBooleanChecker ())
    .AddAttribute ("FixedTti",
                   "Fix slot size",
                   BooleanValue (false),
                   MakeBooleanAccessor (&MmWaveInterAvoidHbfMacScheduler::m_fixedTti),
                   MakeBooleanChecker ())
    .AddAttribute ("SymPerSlot",
                   "Number of symbols per slot in Fixed TTI mode",
                   UintegerValue (6),
                   MakeUintegerAccessor (&MmWaveInterAvoidHbfMacScheduler::m_symPerSlot),
                   MakeUintegerChecker<uint8_t> ())
  ;
...
void
MmWaveInterAvoidHbfMacScheduler::SetMacSchedSapUser (MmWaveMacSchedSapUser* sap)
{
  m_macSchedSapUser = sap;
}

void
MmWaveInterAvoidHbfMacScheduler::SetMacCschedSapUser (MmWaveMacCschedSapUser* sap)
{
...
MmWaveInterAvoidHbfMacScheduler::GetMacSchedSapProvider ()
{
  return m_macSchedSapProvider;
}

MmWaveMacCschedSapProvider*
MmWaveInterAvoidHbfMacScheduler::GetMacCschedSapProvider ()
{
  return m_macCschedSapProvider;
}

void
MmWaveInterAvoidHbfMacScheduler::ConfigureCommonParameters (Ptr<MmWavePhyMacCommon> config)
{
...
void
MmWaveInterAvoidHbfMacScheduler::DoSchedDlRlcBufferReq (const struct MmWaveMacSchedSapProvider::SchedDlRlcBufferReqParameters& params)
{
...
void
MmWaveInterAvoidHbfMacScheduler::DoSchedDlCqiInfoReq (const struct MmWaveMacSchedSapProvider::SchedDlCqiInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
MmWaveInterAvoidHbfMacScheduler::DoSchedUlCqiInfoReq (const struct MmWaveMacSchedSapProvider::SchedUlCqiInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
MmWaveInterAvoidHbfMacScheduler::RefreshHarqProcesses ()
{
  NS_LOG_FUNCTION (this);
...
uint8_t
MmWaveInterAvoidHbfMacScheduler::UpdateDlHarqProcessId (uint16_t rnti)
{
...
uint8_t
MmWaveInterAvoidHbfMacScheduler::UpdateUlHarqProcessId (uint16_t rnti)
{
  NS_LOG_FUNCTION (this << rnti);
...
unsigned MmWaveInterAvoidHbfMacScheduler::CalcMinTbSizeNumSym (unsigned mcs, unsigned bufSize, unsigned &tbSize)
{
...
void
MmWaveInterAvoidHbfMacScheduler::DoSchedTriggerReq (const struct MmWaveMacSchedSapProvider::SchedTriggerReqParameters& params)
{
  ...
  if (ueInfo.size () > 0)
    {
      ...
      for (itUeInfo = ueInfo.begin (); itUeInfo != ueInfo.end (); itUeInfo++)
              {
              NS_LOG_INFO("CLAVE DEL USUARIO: " << itUeInfo->first << ", LAYER DE DL: " << itUeInfo->second.m_dlHbfLayer
                      << ", LAYER DE UP: " << itUeInfo->second.m_ulHbfLayer << " ."); //Observamos que se asignan como rtni numeros enteros a partir del 1 en cada allocat
              }

      int ueNumberLayerSize = round(sqrt((int)ueInfo.size()));  // Calculamos el número de grupos que habrá dependiendo de ueInfo.size();

      NS_LOG_INFO("EL NÚMERO DE GRUPOS QUE VAMOS A TENER EN ESTE CASO ES: " << ueNumberLayerSize << " .");

	  int size = ueInfo.size();

	  std::vector<std::vector<float>> InterferenceTable(size, std::vector<float>(ueInfo.size(), 0.0));

	  // Método Generar valores aleatorios en la mitad superior de la matriz de interferencia
	  for (int A = 0; A < size; A++) {
		  NS_LOG_LOGIC("tabla[" << A << "][" << A << "] = " << InterferenceTable[A][A]);
		  for (int B = A + 1; B < size; B++) {
			  float random = static_cast<float>(rand()) / RAND_MAX; //Número aleatorio entre 0 y 1 redondeado a 1 decimal
			  float randomRounded = std::round(random * 10) / 10;
			  InterferenceTable[A][B] = InterferenceTable[B][A] = randomRounded;
			  NS_LOG_LOGIC("tabla[" << A << "][" << B << "] = " << InterferenceTable[A][B]);
		  }
	  }

	  /*--------------------------------------------------Algoritmo Máxima Interferencia First --------------------------------------------------*/
	  float max = 0.0;
	  std::vector<int> parMax = { -1, -1 };
	  for (int A = 0; A < size; A++) {
		  for (int B = A + 1; B < size; B++) {
		  	  if (InterferenceTable[A][B] > max) { // HAY QUE AÑADIR EL CONDICIONAL DE QUE EL USUARIO != layer(uA)
				  max = InterferenceTable[A][B];
				  parMax = { A, B };
			  }
		  }
	  }
	  NS_LOG_INFO("LA INTERFERENCIA MÁXIMA ENTRE 2 USUARIOS ES: " << max);
	  NS_LOG_INFO("LOS 2 USUARIOS CON MÁS INTERFERENCIA ENTRE ELLOS SON: " << parMax[0]+1 << " Y " << parMax[1]+1);
	  NS_LOG_INFO("EL Nº DE LAYERS EN DL EXISTENTE ES: " << numDlUeLayer.size());

	  for (itUeInfo = ueInfo.begin (); itUeInfo != ueInfo.end (); itUeInfo++) {
		  while (itUeInfo->second.m_dlHbfLayer == 0) {
			/*for (int u = 0; u < N; u++) {
				for (int layer = 0; layer < L; layer++) {
					for (u_1 en usuariosDeLayer[layer]) {
						  interf_accum[u][layer] += C[u][u_1]
					}
				}
			}
			float maxInt = 0.0;
			...
			for (int u = 0; u < N; u++) {
				for (int layer = 0; layer < L; layer++) {
					if (interf_accum[u][layer] > maxInt) {
						maxInt=interf_accum[u][layer]
						max_I=layer
						max_u=u
					}
				}
			}
			asignarUsuarioALayer(max_u,max_l) // */ itUeInfo->second.m_dlHbfLayer = 2;
		  }
	  }

      /*for (itUeInfo = ueInfo.begin (); itUeInfo != ueInfo.end (); itUeInfo++) {
    	  if (itUeInfo->second.m_maxDlSymbols > 0) { 				//SI ESTE USUARIO QUIERE DL
			  itUeToLayerMap = ueToLayerMapDl.find (itUeInfo->first); 	//BUSCAMOS EL USUARIO QUE TENGA ESTA KEY
			  NS_LOG_INFO("Clave: " << itUeInfo->first);
			  if ( itUeToLayerMap == ueToLayerMapDl.begin () ) {
				  layerIdx = 1;
			  }
			  else if ( itUeToLayerMap == ueToLayerMapDl.end () ) {		//SI HEMOS LLEGADO AL FINAL DEL MAPA...
				  layerIdx = 0; //default behavior
				  numDlUeLayer[layerIdx]++;
				  ueToLayerMapDl.insert ( std::pair<uint32_t, uint8_t> ( itUeInfo->first, layerIdx ) ); // key is the rnti
			  } else {												//SI NO HEMOS LLEGADO AL FINAL DEL MAPA...
				  layerIdx = itUeToLayerMap->second;
			  }
			  itUeInfo->second.m_dlHbfLayer = layerIdx;
		  }
	  ...
	  /*--------------------------------------------------Algoritmo Mínima Interferencia First --------------------------------------------------*/
	  /* float min = 10.0;
	  std::vector<int> parMin { -1, -1 };
	  for (int A = 0; A < size; A++) {
		  for (int B = A + 1; B < size; B++) {
			  if ( InterferenceTable[A][B] < min ) { // HAY QUE AÑADIR EL CONDICIONAL DE QUE EL USUARIO != layer(uA)
				  min = InterferenceTable[A][B];
				  parMin = { A, B };
			  }
		  }
	  }
	  NS_LOG_INFO("LA INTERFERENCIA MÍNIMA ENTRE 2 USUARIOS ES: " << min);
	  NS_LOG_INFO("LOS 2 USUARIOS CON MENOS INTERFERENCIA ENTRE ELLOS SON: " << parMin[0]+1 << " Y " << parMin[1]+1);

	  //Asignación usuarios a layers - En cada grupo distinto los que tengan menos interferencia entre ellos
	  ...
	  /*
	  float total_interference = 0.0;

	    for (int A = 0; A < size; A++) {
		    for (int B = A + 1; B < size; B++) {
			    if (layer(ueB) != layer(ueA)) {
				    total_interference += InterferenceTable[A][B];
			    }
		    }
	    }

	  // (1): Esto lo haremos verificando la suma de interferencias de los grupos en los que no
	  vamos a meter nuestro usuario.
	  El siguiente código es de Matlab. Si tenemos una tabla [1 3 5 7 3]:
	  sum(tabla(5,:))-tabla(5,:)
	  >>> 18-[1 3 5 7 3] = 17 15 13 11 15 //Cada término del resultado es la suma de todas las posiciones menos la propia posición.
	  */
      ...
      //Count the demand of symbols in each layer before new allocations
      ...
      for (itUeInfo = ueInfo.begin (); itUeInfo != ueInfo.end (); itUeInfo++) {
	  if (itUeInfo->second.m_maxDlSymbols > 0) { //if this user wants DL allocation
...
void
MmWaveInterAvoidHbfMacScheduler::DoSchedUlMacCtrlInfoReq (const struct MmWaveMacSchedSapProvider::SchedUlMacCtrlInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
MmWaveInterAvoidHbfMacScheduler::DoSchedSetMcs (int mcs)
{
  if (mcs >= 0 && mcs <= 28)
    {
      m_mcsDefaultDl = mcs;
...
bool
MmWaveInterAvoidHbfMacScheduler::SortRlcBufferReq (MmWaveMacSchedSapProvider::SchedDlRlcBufferReqParameters i, MmWaveMacSchedSapProvider::SchedDlRlcBufferReqParameters j)
{
...
void
MmWaveInterAvoidHbfMacScheduler::RefreshDlCqiMaps (void)
{
...
void
MmWaveInterAvoidHbfMacScheduler::RefreshUlCqiMaps (void)
{
  // refresh UL CQI  Map
...
void
MmWaveInterAvoidHbfMacScheduler::UpdateDlRlcBufferInfo (uint16_t rnti, uint8_t lcid, uint16_t size)
{
  NS_LOG_FUNCTION (this);
...
void
MmWaveInterAvoidHbfMacScheduler::UpdateUlRlcBufferInfo (uint16_t rnti, uint16_t size)
{
...
void
MmWaveInterAvoidHbfMacScheduler::DoCschedCellConfigReq (const struct MmWaveMacCschedSapProvider::CschedCellConfigReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
MmWaveInterAvoidHbfMacScheduler::DoCschedUeConfigReq (const struct MmWaveMacCschedSapProvider::CschedUeConfigReqParameters& params)
{
...
void
MmWaveInterAvoidHbfMacScheduler::DoCschedLcConfigReq (const struct MmWaveMacCschedSapProvider::CschedLcConfigReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
MmWaveInterAvoidHbfMacScheduler::DoCschedLcReleaseReq (const struct MmWaveMacCschedSapProvider::CschedLcReleaseReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
MmWaveInterAvoidHbfMacScheduler::DoCschedUeReleaseReq (const struct MmWaveMacCschedSapProvider::CschedUeReleaseReqParameters& params)
{
