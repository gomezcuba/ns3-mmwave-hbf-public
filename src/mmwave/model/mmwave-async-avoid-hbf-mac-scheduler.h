...
class MmWaveInterAvoidHbfMacScheduler : public MmWaveMacScheduler
{
public:
  ...
  MmWaveInterAvoidHbfMacScheduler ();

  virtual ~MmWaveInterAvoidHbfMacScheduler ();
  ...
  friend class MmWaveInterAvoidHbfMacSchedSapProvider;
  friend class MmWaveInterAvoidHbfMacCschedSapProvider;
